...
<!--[if lt IE 9]><p class="chromeframe">You are using an <strong>outdated</strong> browser. Please <a href="http://browsehappy.com/">upgrade your browser</a> to improve your experience.</p><![endif]-->
  ...
  <header id="header" class="quicksand u-uppercase">
    ...
    <nav id="mobile-menu">
      <a href="#" id="mobile-toggle"><svg height="24px" version="1.1" viewBox="0 0 24 24" width="24px" xmlns="http://www.w3.org/2000/svg" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns" xmlns:xlink="http://www.w3.org/1999/xlink"><g fill-rule="evenodd" id="miu" stroke="none" stroke-width="1"><g id="Artboard-1" transform="translate(-395.000000, -479.000000)"><g id="slice" transform="translate(215.000000, 119.000000)"/><path d="M396.500836,485 C396.224232,485 396,485.214035 396,485.504684 L396,486.495316 C396,486.774045 396.217742,487 396.500836,487 L417.499164,487 C417.775768,487 418,486.785965 418,486.495316 L418,485.504684 C418,485.225955 417.782258,485 417.499164,485 L396.500836,485 Z M396.500836,490 C396.224232,490 396,490.214035 396,490.504684 L396,491.495316 C396,491.774045 396.217742,492 396.500836,492 L417.499164,492 C417.775768,492 418,491.785965 418,491.495316 L418,490.504684 C418,490.225955 417.782258,490 417.499164,490 L396.500836,490 Z M396.500836,495 C396.224232,495 396,495.214035 396,495.504684 L396,496.495316 C396,496.774045 396.217742,497 396.500836,497 L417.499164,497 C417.775768,497 418,496.785965 418,496.495316 L418,495.504684 C418,495.225955 417.782258,495 417.499164,495 L396.500836,495 Z" id="editor-list-view-hambuger-menu-glyph"/></g></g></svg></a>
      <ul>
        <li><a href="<?php echo get_page_permalink_from_slug('about'); ?>">About</a></li>
        <li><a href="<?php echo get_post_type_archive_link('area'); ?>">Áreas de Práctica</a></li>
        <li><a href="<?php echo get_page_permalink_from_slug('blog'); ?>">Blog</a></li>
        <li><a href="<?php echo get_page_permalink_from_slug('contacto'); ?>">Contacto</a></li>
      <li><a href="<?php echo get_page_permalink_from_slug('aviso-de-privacidad') ?>">Aviso de privacidad</a></li>
        <li><a href="http://www.legalix.com/" target="_blank">Legalix.com</a></li>
        <li>- -</li>
        <li><p>Todos los derechos reservados. Mier Esparza Abogados 2015</p></li>
      </ul>
    </nav>
